      ...
      {showActions && request.backendStatus === "pending" && (
        ...
        <div className="flex space-x-3">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center space-x-2 px-4 py-2 text-white rounded-lg transition-colors text-sm hover:opacity-90 disabled:opacity-50"
        ...
        <div className="space-y-8">
          ...
          {activeRequests.length > 0 ? (
            ...
            >
              ...
              No pending home visits right now.
          ...
          <MissedAppointmentsPanel
            ...
            description="These requests expired before you responded."
