        ...
        diseaseHistory: [
            {
                ...
                treatedBy: "Dr. Smith",
                notes: "Patient is managing diabetes with medication and lifestyle changes.",
            },
        ],
    };
                ...
                <div className="bg-white rounded-xl shadow-sm p-8 mb-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-foreground">Address (optional)</label>
                                <textarea
                    ...
                    <div className="mb-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-yellow-700 mt-1">
                                Your medical history can only be updated by your doctor or administrator for accuracy and security purposes.
                            </p>
                        </div>
                    </div>
                                    ...
                                    <div className="flex items-start justify-between mb-4">
                                        <div className="flex-1">
                                            <div className="flex items-center space-x-3 mb-2">
                                                <h3 className="text-lg font-semibold text-foreground">{record.disease}</h3>
                                                <span className={`px-3 py-1 text-xs rounded-full font-medium border ${getStatusColor(record.status)}`}>
                                            ...
                                            <div className="space-y-2">
                                                <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                                                    ...
                                                    <span>Diagnosed: {new Date(record.diagnosedDate).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}</span>
                                                </div>
                                                <div className="flex items-center space-x-2 text-sm text-muted-foreground">
