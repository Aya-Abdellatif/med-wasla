          ...
          <div className="grid grid-cols-2 md:grid-cols-4">
            {stats.map((stat, idx) => (
              <div
                ...
                className={`
            text-center p-5
            ${idx % 2 === 1 ? "border-l border-gray-100 rtl:border-l-0 rtl:border-r" : ""}
            ${idx > 1 ? "border-t border-gray-100" : ""}
            md:border-t-0
            md:border-l
            rtl:md:border-l-0 rtl:md:border-r
            ${idx === 0 ? "md:border-l-0 rtl:md:border-r-0" : ""}
          `}
              >
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-2xl font-bold text-[#1F2937]">
                  {t(`about:missionVision.${item.key}.title`)}
                </h2>
              </div>

              <p className="mt-5 text-sm md:text-base font-normal leading-relaxed text-[#6B7280]">
                {t(`about:missionVision.${item.key}.description`)}
              </p>
            </article>
          ))}
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            <h3 className="text-3xl font-bold tracking-tight text-[#1F2937] sm:text-4xl">
              {t("about:coreValues.sectionTitle")}
            </h3>

            <p className="mt-4 text-base md:text-lg font-normal text-[#6B7280]">
              {t("about:coreValues.sectionSubtitle")}
            </p>
          </div>
      ...
      <section className="bg-[#FFFFFF] px-5 py-20">
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-base md:text-lg font-normal text-[#6B7280]">
              {t("about:whyChooseUs.sectionSubtitle")}
            </p>
          </div>
            ...
            {servicesHighlight.map((item) => (
              ...
              >
                ...
                <h4 className="mt-5 text-lg font-bold text-[#1F2937]">
                  {t(`about:whyChooseUs.${item.key}.title`)}
                </h4>

                <p className="mt-3 text-xs md:text-sm font-normal leading-relaxed text-[#6B7280]">
                  {t(`about:whyChooseUs.${item.key}.description`)}
                </p>
              </div>
            ))}
          </div>
